...
const chaincodeName = envOrDefault('CHAINCODE_NAME', 'assetprice');
...
async function initLedger(contract) {
    console.log(
        '\n--> Submit Transaction: InitLedger, function creates the initial set of price assets on the ledger'
    );
...
async function createAsset(contract) {
    console.log(
        '\n--> Submit Transaction: CreateAsset, creates new price asset with ID, ProductID, Price, Payer, Payee arguments'
    );
