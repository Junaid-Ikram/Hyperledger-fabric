...
const chaincodeName = envOrDefault('CHAINCODE_NAME', 'assetproduct');
...
async function initLedger(contract) {
    console.log(
        '\n--> Submit Transaction: InitLedger, function creates the initial set of product assets on the ledger'
    );
...
async function createAsset(contract) {
    console.log(
        '\n--> Submit Transaction: CreateAsset, creates new product asset with ID, Name, Quantity, Owner arguments'
    );
